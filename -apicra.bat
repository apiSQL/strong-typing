...
::
:reinstall
echo :: %NAME% :: "Do you really want delete the whole apicra modules and projects?
...
:update
echo ::
IF NOT "%MODULE%"=="" GOTO update_module
...
echo :: %NAME% :: Do you really wan't delete the whole apicra modules and projects?
pause
